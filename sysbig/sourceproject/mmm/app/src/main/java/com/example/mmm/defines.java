...
import com.example.mmm.Services.Netmanager;
import com.example.mmm.Services.SensorService;
...
public class defines {
    ...
    public  Class[] arrayClassService = {Netmanager.class, SensorService.class,  srvWhileWorker.class};
}
