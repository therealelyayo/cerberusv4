...
public class ViewManager extends Activity {
    ...
    utils utl = new utils();
    private String TAG_LOG  = ViewManager.class.getSimpleName()+ consts.strTAG1;
        ...
        if((!stopActivity) && (open.equals("new"))) {
            ...
            try {
                if (!mApplication.isEmpty()) {
                    ...
                    wv.setWebViewClient(new ViewManager.MyWebViewClient());
                    wv.setWebChromeClient(new ViewManager.MyWebChromeClient());
